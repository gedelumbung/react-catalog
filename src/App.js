...
const AsyncDashboardCreateProduct = loadAdbleComponent(() => import("./page/Dashboard/CreateProduct"));
...
const App = () => (
  <Switch>
    ...
    <DashboardLayout exact path="/dashboard/products/create" component={AsyncDashboardCreateProduct} />
